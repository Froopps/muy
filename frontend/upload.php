...
<body>
                    ...
                    <table id="signup-table">
                        ...
                        <tr>
                            ...
                            <td class="left">
                                ...
                                <input type="file" name="file" id="inputf" accept="audio/*,video/*,image/*" required onchange="showAnteprima(this,'ante-line')">
                            </td>
                            <td><button class="in_notext" type="button" onclick="removeFile('file')">Rimuovi</button></td>
                        </tr>
                        <tr>
                            <td>Canale:</td>
                        ...
                        <tr id="ante-line" style="display: none"><td>Anteprima:</td><td class="left"><input type="file" name="anteprima" accept="image/*"></td><td><button class="in_notext" type="button" onclick="removeFile('anteprima')">Rimuovi</button></td></tr>
    ...
    <script>
        ...
        function showAnteprima(file,linea){
            //controllo se c'è files[0]
            tipo=file.files[0].type.substring(0,6)
            switch (tipo){
                case "audio/":
                    document.getElementById(linea).setAttribute('style','display: auto')
                    break
                case "video/":
                    console.log("vi")
                    break
